...
#listen_friend_names = '大头|宙宙|乔凯|战术鬼才泰伦卢'  # 需要监听的人名称，使用备注名更安全，允许多个用|分隔，如：主管|项目经理|产品狗
#listen_friend_groups = '王者吃鸡小分队。'  # 在这些群里监听好友说的话，匹配模式：包含“唯一集团工作群”的群


# 转发信息至群
#is_forward_mode = False  # 打开转发模式，主人发送给机器人的消息都将转发至forward_groups群
#forward_groups = '王者吃鸡小分队。'  # 需要将消息转发的群，匹配模式同上

# 群分享监控
#is_listen_sharing = False
#listen_sharing_groups = '王者吃鸡小分队。'  # 监控群分享，匹配模式同上
